...
import com.cqupt.dto.AdminUserDetails;
import com.cqupt.component.JwtAuthenticationTokenFilter;
import com.cqupt.component.RestAuthenticationEntryPoint;
import com.cqupt.component.RestfulAccessDeniedHandler;
...
//                .permitAll()
    ...
    /**
     * 用于配置UserDetailsService以及PasswordEncoder
     * @param auth
     * @throws Exception
     */
    @Override
